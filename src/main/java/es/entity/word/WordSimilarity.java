...
public class WordSimilarity {
    ...
    public static void loadGlossary() {
        ...
        try {
            //reader = new BufferedReader(new FileReader("E:\\搜狗高速下载\\85317625WordSimilarityJAVA- (1)\\WordSimilarity\\dict\\glossary.dat"));
            reader = new BufferedReader(new InputStreamReader(new FileInputStream(
                    "E:\\搜狗高速下载\\85317625WordSimilarityJAVA- (1)\\WordSimilarity\\dict\\glossary.dat"),"GB2312"));
